      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            ...
            <p className="text-3xl font-bold text-purple-600">{expenseRatio.toFixed(1)}%</p>
            <p className="text-xs text-gray-500 mt-1">
              {expenseRatio < 30 ? 'Excellent' : expenseRatio < 50 ? 'Good' : expenseRatio < 70 ? 'Fair' : 'High'}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Profitability Analysis</h3>
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center pt-2">
                ...
                <span className={`font-bold text-lg ${netIncome >= 0 ? 'text-blue-600' : 'text-red-600'}`}>
                  ₹{netIncome.toLocaleString()}
                </span>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Key Ratios</h3>
            <div className="space-y-3">
              <div className="flex justify-between items-center pb-2 border-b">
